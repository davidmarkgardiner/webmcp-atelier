...
- [x] GatherGraph selected through the documented native bake-off.
...
- [x] Thirteen-tool ownership model documented.
...
- [x] Project description drafted against the four required questions.
...
Do not submit if the live URL is unavailable, native discovery is unproven on the hosted build, the repository is not public and licensed, the video is not publicly viewable, or any placeholder remains.
