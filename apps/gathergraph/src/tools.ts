...
const definitions: readonly [
  ...
  [
    "food",
    "build_menu",
    "Build a fictional catered vegan menu for the event.",
  ...
  [
    ...
    "Preview a fictional catering reservation without booking.",
  ...
  [
    ...
    "Find a fictional catering delivery and setup window that fits venue access.",
  ...
  [
    "logistics",
    "estimate_footprint",
    "Estimate the illustrative impact of the catering delivery route.",
  ...
  [
    ...
    "Preview a fictional catering delivery slot without booking.",
    objectSchema({ route: { type: "string" } }, ["route"]),
    { readOnlyHint: true },
  ],
  [
    "parent",
    "compose_event_plan",
    "Compose venue, catering, access, and setup fixtures into one event plan.",
